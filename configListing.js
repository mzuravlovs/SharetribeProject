...
export const listingFields = [
  ...
  {
    key: 'deliveryPricePerKm',
    scope: 'public',
    schemaType: 'long',  // 'long' for number values
    showConfig: {
    ...
    saveConfig: {
        label: 'Delivery price per kilometer',
        placeholderMessage: 'Enter price per km (e.g. 2.50)',
        isRequired: false,
    },
    filterConfig: {
        indexForSearch: true,  // If you want to enable filtering by this field
        label: 'Delivery price per kilometer',
        group: 'secondary'
    }
}
